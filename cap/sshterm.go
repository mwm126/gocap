...
func ConnectSsh(a fyne.App, host, user, pass string) {
	var debug bool
	...
	askForSSH(t, w, a, host, user, pass)
	w.ShowAndRun()
}
...
func askForSSH(t *termResizer, w fyne.Window, a fyne.App, h, u, p string) {
